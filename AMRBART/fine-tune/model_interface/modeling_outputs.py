...
@dataclass
class Dual2SeqModelOutput(ModelOutput):
    """
    Base class for model encoder's outputs that also contains : pre-computed hidden states that can speed up sequential
    decoding.
    ...
    encoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    encoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
    graph_encoder_last_hidden_state: Optional[torch.FloatTensor] = None
    graph_encoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    graph_encoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
...
@dataclass
class Dual2SeqLMOutput(ModelOutput):
    """
    Base class for sequence-to-sequence language models outputs.
